	...
	<body>
        ...
        <section id="home" data-role="page" data-theme="b">
            <header data-role="header">
                ...
                <h1>
                    My App <?php if ($number >= 1) { print $user ; } else { print "*** Utente non inserito nel Database ***"; } ?> -Home-
                </h1>
            </header>
            <div data-role="content" class="content">
				...
				print "<center><p>Non hai ancora inserito nessuna Pagina Home</p></center>";
				}
				...
				echo "<DIV STYLE='position:relative;padding-top:10px;padding-left:10px;padding-right:10px;'>"; print $homepage ;
					if ($attivo < 1) 
					{
