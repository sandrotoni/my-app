...
<html>
	...
	<body>
        ...
        <section id="gservizi" data-role="page" data-theme="b">
            ...
            <div data-role="content" class="content">
                ...
                <ul data-role="listview" data-inset="true" data-theme="c">
					<li>
						Crea o modifica il contenuto della Pagina dei Servizi della tua Applicazione.
                    </li>
				</ul>
				<?php
						$table_contatti = "servizi";
				...
				?>
				<?php if (isset($_POST['servizibox'])) : 
				 
				mysql_select_db("$db_name",$connessione); 
				 

					$servizibox = $_POST['servizibox'];

					if ($contatore < 1) {
					
						$sql = "INSERT INTO servizi (utente, servizi)
						
						VALUES ('$userid','$servizibox')
						";
					...
					if (@mysql_query($sql)) 
					    ...
					    echo '<p><center><h1>Pagina dei Servizi modificata con successo</h1></center></p>';
				...
				<a href="#"id="PageServiziRefresh"  data-role="button" data-icon="gear" data-theme="b">***IMPORTANTE*** Carica l'editor della Pagina Servizi</a>
					<script type="text/javascript">
						$('#PageServiziRefresh').click(function() {
								  location.reload();
						});
					</script>
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					<label><em>Inserire qui il contenuto della Pagina dei Servizi. Una volta terminato cliccare sul pulsante "SALVA" per salvare i cambiamenti.</em></label>
					<textarea class="ckeditor" name="servizibox" id="servizibox" style="width:100%">
					<?php
						$table = "servizi";
						...
						print "Non hai ancora inserito nessuna Pagina dei Servizi.";
						}
						...
						$servizibox = mysql_result($result,$i,"servizi");
						print $servizibox;
						$i++;
						}
            ...
            <footer data-role="footer" data-position="fixed">
				<div data-role="navbar">
					<ul>
						...
						<li><a href="#" class="ui-btn-active ui-state-persist" data-icon="check">Gestione Servizi</a></li>
